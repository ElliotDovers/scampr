...
#'
#' @param scampr.model a scampr model: object of class 'scampr' that provides the framework for the search algorithm. Recommended that an IPP model of the appropriate type is used.
...
#' @param loglik.type a character string indicating the type of approximation to use for the intractable marginalisation. One of 'variational', 'laplace' or 'both'. Currently variational (and hence both) is only available to PO models.
